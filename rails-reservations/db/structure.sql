...
--
-- Name: events no_overlaps; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY events
    ADD CONSTRAINT no_overlaps EXCLUDE USING gist (daterange(start_date, end_date, '[]'::text) WITH &&) DEFERRABLE;
